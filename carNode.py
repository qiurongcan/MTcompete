...
class CarNode(DemoPipeline):
    def __init__(self, node_name='qrcCarNode', show=False):
        ...
        self.car_drone_route = {
            ...
            "SIM-MAGV-0002": [Position(187, 431, -90), Position(490, 390, -90), Position(490, 390, -26)],
            "SIM-MAGV-0003": [Position(181, 432, -72), Position(508, 514 ,-72), Position(508, 514 ,-26)], 
            "SIM-MAGV-0004": [Position(199, 431, -100), Position(430, 184, -100), Position(430, 184, -14)],  
            "SIM-MAGV-0005": [Position(181, 432, -80), Position(564, 394, -80), Position(564, 394, -20)], 
