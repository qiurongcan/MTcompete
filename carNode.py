...
class CarNode(DemoPipeline):
    def __init__(self, node_name='qrcCarNode', show=False):
        ...
        self.five_fly_car_route = [Position(181, 432, -16), Position(186, 435, -16), Position(186, 438, -16)]
        ...
        self.car_route = {
            ...
            "SIM-MAGV-0002": [Position(187, 431, -16), Position(187, 427, -16), Position(190, 425, -16)], # 折线
            ...
            "SIM-MAGV-0005": [Position(186, 438, -16), Position(186, 435, -16), Position(181, 433, -16), Position(181, 427, -16), Position(190, 425, -16)],  
        ...
        self.car_drone_route = {
            "SIM-MAGV-0001": [Position(193, 431, -75), Position(508, 514 ,-75), Position(508, 514 ,-26)],   
            "SIM-MAGV-0002": [Position(187, 431, -85), Position(564, 394, -85), Position(564, 394, -20)],  
            "SIM-MAGV-0003": [Position(181, 432, -80), Position(490, 390, -80), Position(490, 390, -26)],
            "SIM-MAGV-0004": [Position(199, 431, -70), Position(430, 184, -70), Position(430, 184, -14)],  # 不变
            "SIM-MAGV-0005": [Position(181, 432, -66), Position(130, 298, -66), Position(148, 184, -66), Position(146, 186, -38)],  
            "SIM-MAGV-0006": [Position(197, 446, -115), Position(528, 172, -115), Position(528, 172, -24)],  #不变
        }

        # 【决赛】修改所有小车的初始位置 6号小车不动
        self.init_pos = {
            "SIM-MAGV-0001": Position(193, 431, -16), 
            "SIM-MAGV-0002": Position(187, 431, -16), 
            "SIM-MAGV-0003": Position(181, 432, -16), # 3号小车提前起飞
            "SIM-MAGV-0004": Position(199, 431, -16), 
    ...
    def inspect_car(self, cars):
        ...
        for car in cars:
            ...
            # ----------------动态小车调度代码----------------------- #
        # if self.flag == 1:
        #     print("=====Receive msg", self.flag)

        if sum(car_sum) == 6 or self.flag > 0: # self.flag == 1 or  self.flag == 2
            self.state = WorkState.RUNNING_CAR
        else:
            self.state = WorkState.STOP_CAR
        # 每辆车都处于可运行状态
