...
class UserNode(DemoPipeline):
    def __init__(self, node_name='qrcUserNode', show=False):
        ...
        # 【决赛】TODO 小车返回的路线及目标点需要改变, 小车6 不动
        self.car_back_route = {
            "car1": [Position(190, 425, -16), Position(193, 431, -16)], # 修改
            "car2": [Position(190, 425, -16), Position(187, 427, -16), Position(187, 431, -16)], # 修改
            "car3": [Position(190, 425, -16), Position(181, 427, -16), Position(181, 432, -16)],
            "car4": [Position(190, 425, -16), Position(199, 426, -16), Position(199, 431, -16)],# 修改
            "car5": [Position(190, 425, -16), Position(181, 427, -16), Position(181, 432, -16)],
            "car6": [Position(190, 425, -16), Position(190, 446, -16), Position(196, 446, -16)],# 6号小车不动
        }
