...
class DroneNode(DemoPipeline):
    def __init__(self, node_name='qrcDroneNode', show=False):
        ...
        # 存储六个目的地的航线
        self.fly_line ={
            'pos1': [Position(148, 184, -66), Position(130, 298, -66), Position(191, 431, -66), Position(191, 431, -21)],
            'pos5': [Position(564, 394, -80), Position(196, 440, -80),Position(196, 440, -21)],# 不动
            'pos4': [Position(508, 514 ,-72), Position(182, 440, -72), Position(182, 440, -21)],
            'pos2': [Position(430, 184, -100), Position(198, 432, -100), Position(198, 432, -21)],
            'pos3': [Position(528, 172, -115), Position(196, 446, -115), Position(196, 446, -21)], # 不动
            'pos6': [Position(490, 390, -90), Position(188, 438, -90), Position(188, 438, -21)],
        }
