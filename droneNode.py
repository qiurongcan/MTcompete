...
class DroneNode(DemoPipeline):
    def __init__(self, node_name='qrcDroneNode', show=False):
        ...
        self.fly_line ={
            ...
            'pos5': [Position(564, 394, -85), Position(186, 438, -85),Position(186, 438, -20)],# 5
            'pos4': [Position(508, 514 ,-75), Position(181, 440, -75), Position(181, 440, -20)], # 3
            ...
            'pos6': [Position(490, 390, -80), Position(187, 431, -80), Position(187, 431, -20)], # 2
        }
